...
from nets.utils import layers_utils
from nets.utils import ssd_utils
import utils.basic_tools.tensors as tfe
...
class SSDNet(object):
    ...
    default_params = SSDParams(
        ...
        anchor_size_bounds=[0.15, 0.90],  # 特征图尺度范围0.15 ~ 0.90
        # 锚点框anchor boxes的大小
        anchor_sizes=[(21., 45.),
                      (45., 99.),
                      (99., 153.),
        ...
        anchor_ratios=[[2, .5],
                       ...
                       [2, .5],
                       [2, .5]],
        # 特征图的锚点框anchor box放大到原始图的缩放比例
        anchor_steps=[8, 16, 32, 64, 100, 300],
        # 每个锚点框anchor box中心点在该特征图cell中心，因此offset=0.5
        anchor_offset=0.5,
        # 该特征层是否正则化，大于零即正则；小于零则否
    ...
    def bboxes_encode(self, labels, bboxes, anchors,
        ...
        """
        return ssd_utils.tf_ssd_bboxes_encode(
    ...
    def bboxes_decode(self, feat_localizations, anchors,
        ...
        """
        return ssd_utils.tf_ssd_bboxes_decode(
    ...
    def detected_bboxes(self, predictions, localisations,
        ...
        rscores, rbboxes = \
            ssd_utils.tf_ssd_bboxes_select(predictions, localisations,
...
def ssd_net(inputs,
    ...
    with tf.variable_scope(scope, 'ssd_300_vgg', [inputs], reuse=reuse):
        ...
        with tf.variable_scope(end_point):
            ...
            net = layers_utils.pad2d(net, pad=(1, 1))
...
def ssd_arg_scope(weight_decay=0.0005, data_format='NHWC'):
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d],
            ...
            with slim.arg_scope([layers_utils.pad2d,
                                 layers_utils.l2_normalization,
                                 layers_utils.channel_to_last],
...
def ssd_arg_scope_caffe(caffe_scope):
    ...
    with slim.arg_scope([slim.conv2d],
        ...
        with slim.arg_scope([slim.fully_connected],
                            activation_fn=tf.nn.relu):
            with slim.arg_scope([layers_utils.l2_normalization],
...
def ssd_losses(logits, localisations,
    ...
    with tf.name_scope(scope, 'ssd_losses'):
        ...
        with tf.name_scope('localization'):
            ...
            loss = layers_utils.abs_smooth(localisations - glocalisations)
            ...
            for i in range(len(logits)):
                ...
                with tf.name_scope('block_%i' % i):
                    ...
                    with tf.name_scope('localization'):
                        # Weights Tensor: positive mask + random negative.
                        weights = tf.expand_dims(alpha * fpmask, axis=-1)
                        loss = layers_utils.abs_smooth(localisations[i] - glocalisations[i])
