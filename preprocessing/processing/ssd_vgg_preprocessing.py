...
from preprocessing.utils import image_tools
from tensorflow.python.ops import control_flow_ops

import utils.basic_tools.bboxes as tfe
...
def preprocess_for_train(image, labels, bboxes,
    ...
    with tf.name_scope(scope, 'ssd_preprocessing_train', [image, labels, bboxes]):
        ...
        dst_image = image_tools.resize_image(dst_image, out_shape,
                                             method=tf.image.ResizeMethod.BILINEAR,
                                             align_corners=False)
        tf_summary_image(dst_image, bboxes, 'image_shape_distorted')

        # Randomly flip the image horizontally.
        dst_image, bboxes = image_tools.random_flip_left_right(dst_image, bboxes)
...
def  preprocess_for_eval(image, labels, bboxes,
    ...
    with tf.name_scope(scope):
        ...
        if resize == Resize.NONE:
            ...
            image, bboxes = image_tools.resize_image_bboxes_with_crop_or_pad(
            ...
            image = image_tools.resize_image(image, resize_shape,
                                          method=tf.image.ResizeMethod.BILINEAR,
                                          align_corners=False)
            ...
            image = image_tools.resize_image(image, out_shape,
                                          method=tf.image.ResizeMethod.BILINEAR,
                                          align_corners=False)
